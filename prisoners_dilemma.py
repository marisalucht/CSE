...
def get_action(player, history, opponent_history, score, opponent_score, getting_team_name=False):
    ...
    #
        ...
        if getting_team_name:
            return 'switch every round'
        else:
            # use history, opponent_history, score, opponent_score
            # to compute your strategy
            if len(opponent_history)==0: #It's the first round: collude
                return 'c'
            elif history[-1]=='c': #Collude last round, betray this round
                return 'b'
            else:
                return 'c'
    ...
    #
        ...
        if getting_team_name:
            return 'stuck in the past'
        else:
            # use history, opponent_history, score, opponent_score
            # to compute your strategy
            if len(opponent_history)==0 or len(opponent_history)==1 : #It's the first two rounds: collude
                return 'c'
            elif history[len(opponent_history)-2]=='c' and opponent_history[len(opponent_history)-2]=='b':
                return 'b' # betray is they were severely punished last time
            else:
                return 'c' #otherwise collude
    ...
    #
        ...
        if getting_team_name:
            ...
            # use history, opponent_history, score, opponent_score
            # to compute your strategy
            if random.random()<0.5: #randomly choose action
                return 'c'
            else:
